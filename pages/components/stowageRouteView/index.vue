  ...
  <view>
    <view class="wrap">
      <view class="u-tabs-box">
        <u-tabs-swiper activeColor="#016B09" ref="tabs" :list="tabList" :current="current" @change="change" :is-scroll="false" swiperWidth="750"></u-tabs-swiper>
      </view>
      <swiper class="swiper-box" :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish">
        <swiper-item class="swiper-item">
          <scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
            <view v-if="missionList[2].length>0" class="page-box">
              <view  class="order" v-for="(res, index) in missionList[2]" :key="index">
                <view class="top">
                  <view class="left">
                    <u-icon name="home" :size="30" color="rgb(94,94,94)"></u-icon>
                    <view class="store">往 {{ res.destinationName }}</view>
                    <u-icon name="arrow-right" color="rgb(203,203,203)" :size="26"></u-icon>
                  </view>
                  <view class="right"><u-tag :text="stowageStatusFormat(res.stowageStatus)" :type="stowageStatusTagFormat(res.stowageStatus)" /></view>
                </view>
                <!--
                ...
                <view class="bottom">
                  ...
                  <u-row gutter="16" justify="end">
                    <u-col span="6">
                      <u-button type="info" hair-line size="mini" shape="circle" ripple plain @click="jumpRoutePage(res.stowageId)">查看</u-button>
                    </u-col>
                    <view v-if="res.stowageStatus==2">
                      <u-col span="6">
                        <u-button type="primary" hair-line size="mini" shape="circle" ripple plain>确认</u-button>
                      </u-col>
                    </view>
                  </u-row>
                </view>
        ...
        <swiper-item class="swiper-item">
          <scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
            <view v-if="missionList[1].length>0" class="page-box">
              <view class="order" v-for="(res, index) in  missionList[1]" :key="res.id">
                <view class="top">
                  <view class="left">
                    <u-icon name="home" :size="30" color="rgb(94,94,94)"></u-icon>
        ...
        <swiper-item class="swiper-item">
          <scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
            <view class="page-box">
              <view v-if="missionList[2].length>0" class="order" v-for="(res, index) in missionList[2]" :key="index">
                <view class="top">
                  <view class="left">
                    <u-icon name="home" :size="30" color="rgb(94,94,94)"></u-icon>
                    <view class="store">往 {{ res.destinationName }}</view>
                  ...
                  <view class="right">{{ res.departureVehiclePlate }}</view>
                </view>
                <!--
                <view class="item" v-for="(item, index) in res.goodsList" :key="index">
                  <view class="left"><image :src="item.goodsUrl" mode="aspectFill"></image></view>
...
export default {
  ...
  methods: {
    getData(){
      uni.showLoading();
      this.$u.get( '/wms/WmsStowage/getDriverMission/0' ).then( res => {
        this.dataList=res
    ...
    getDictDataMethods(){
      this.$u.get('/system/dict/data/type/wms_stowage_status').then( res => {
